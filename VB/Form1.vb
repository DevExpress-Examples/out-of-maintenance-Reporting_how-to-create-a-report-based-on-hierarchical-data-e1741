    ...
    Public Partial Class Form1
        ...
        Private Sub AddDataFieldsToBand(ByVal dataTable As DataTable, ByVal band As DetailBand, ByVal dataPath As String, ByVal addKeyFields As Boolean)
            ...
            For i As Integer = 0 To dataTable.Columns.Count - 1
                ...
                If addKeyFields OrElse (Not addKeyFields AndAlso Not dataColumn.ColumnName.ToUpper().Contains("ID")) Then table.Rows(0).Cells(Math.Min(Threading.Interlocked.Increment(cellIndex), cellIndex - 1)).DataBindings.Add("Text", Nothing, dataPath & "." & dataColumn.ColumnName)
            Next
